...
class pkt_tx_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, InFile='default', MTU=1500):
        gr.top_block.__init__(self, "pkt_tx_rx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pkt_tx_rx")
        ...
        self.connect((self.blocks_repack_bits_bb_0_0_1, 0), (self.fec_extended_tagged_encoder_0_1, 0))
        ...
        self.connect((self.blocks_throttle2_0_1, 0), (self.analog_agc_xx_0, 0))
...
def main(top_block_cls=pkt_tx_rx, options=None):
    ...
    tb = top_block_cls(InFile=options.InFile, MTU=options.MTU)

...
class BPSK_Tx_Rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500, puncpat='11'):
        ...
        self.settings = Qt.QSettings("GNU Radio", "BPSK_Tx_Rx")
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, '/home/gnuradio/Documents/DigitalCommDesign/text/rx.txt', False)
        ...
        self.connect((self.blocks_pack_k_bits_bb_0, 0), (self.digital_crc32_bb_0_0, 0))
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.fec_extended_tagged_encoder_0_1, 0))
        ...
        self.connect((self.fec_extended_tagged_decoder_2, 0), (self.blocks_pack_k_bits_bb_0, 0))
...
def main(top_block_cls=BPSK_Tx_Rx, options=None):
    if options is None:

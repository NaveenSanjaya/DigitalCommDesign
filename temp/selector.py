...
class selector(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        _toggle_toggle_button = qtgui.ToggleButton(self.set_toggle, 'switch', self._toggle_choices, True, 'value')
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 100, 1, 0, 0)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.toggle, 'state'), (self.blocks_selector_0, 'iindex'))

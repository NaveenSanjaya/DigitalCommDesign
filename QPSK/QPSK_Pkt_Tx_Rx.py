...
class QPSK_Pkt_Tx_Rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'E:\\Projects\\DigitalCommDesign\\src\\img_tx.tmp', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'E:\\Projects\\DigitalCommDesign\\src\\img_rx.tmp', False)

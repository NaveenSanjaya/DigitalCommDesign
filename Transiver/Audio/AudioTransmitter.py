...
# Title: AudioTransmitter_grc
# Author: StarLink
# Copyright: StarLink
# Description: Fm audio transmitter
...
class AudioTransmitter(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "AudioTransmitter_grc", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AudioTransmitter_grc")
        ...
        self.settings = Qt.QSettings("GNU Radio", "AudioTransmitter")

...
def snipfcn_snippet_0(self):
    ...
    if __name__ == "__main__":
        ...
        cmd = r'vlc dshow:///dev/video0 --sout="#transcode{vcodec=mp2v,vb=200,scale=0.25,acodec=none,scodec=none}:duplicate{dst=file{dst=./in.ts,no-overwrite},dst=display}" --sout-all --sout-keep'

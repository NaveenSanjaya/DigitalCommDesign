...
class TransmittingApp(ctk.CTk):
    def __init__(self):
        ...
        self.landing_frame = ctk.CTkFrame(self, width=600, height=480, fg_color="#FBE4D8")  # Right-side background color
        ...
        self.background_img = Image.open(os.path.join(self.path, "background_img.jpg"))
        self.side_img = ctk.CTkImage(dark_image=self.background_img, light_image=self.background_img, size=(300, 480))
        self.side_label = ctk.CTkLabel(self.landing_frame, text="", image=self.side_img)
    ...
    def reciver_page(self):
        ...
        # Left side bar
        sidebar_frame = ctk.CTkFrame(master=self.receive_frame, fg_color="#522B5B", width=150, height=480, corner_radius=0)
        ...
        self.antenna_img = ctk.CTkImage(dark_image=self.antenna_img_data, light_image=self.antenna_img_data, size=(100, 100))
        ctk.CTkLabel(master=sidebar_frame, text="", image=self.antenna_img).pack(pady=(120, 0), anchor="center")

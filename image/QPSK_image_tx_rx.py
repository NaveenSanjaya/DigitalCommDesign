...
class QPSK_image_tx_rx(gr.top_block, Qt.QWidget):

    def __init__(self, MTU=1500):
        gr.top_block.__init__(self, "QPSK_image_tx_rxgrc", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK_image_tx_rxgrc")
        ...
        self.settings = Qt.QSettings("GNU Radio", "QPSK_image_tx_rx")
        ...
        for c in range(1, 2):
            self.controls_grid_layout_0.setColumnStretch(c, 1)
        self._delay_range = Range(0, 200, 1, 30, 200)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/gnuradio/Documents/DigitalCommDesign/image/flower_tx.jpg', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/gnuradio/Documents/DigitalCommDesign/image/flower_rx.jpg', False)
...
def main(top_block_cls=QPSK_image_tx_rx, options=None):
    if options is None:
